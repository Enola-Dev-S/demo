...
<template>
  <nav v-if="isAuthenticated" class="p-4 bg-gray-800 text-white mb-4 px-auto">
    <div class="flex justify-between items-center">
      <div class="flex items-center w-full justify-between">
        <ul class="flex space-x-4 items-center">
          ...
          <li>
            <RouterLink to="/" class="nav-item" active-class="bg-gray-900 text-white"
              >HOME</RouterLink
            >
          </li>
          <!-- <li>
            <RouterLink to="/about" class="nav-item" active-class="bg-gray-900 text-white"
              >About</RouterLink
            >
          </li>
          <li>
            <RouterLink to="/game" class="nav-item" active-class="bg-gray-900 text-white"
              >Game</RouterLink
            >
          </li> -->
          <li v-if="userRole === 'administrator'">
            <RouterLink to="/Administrator" class="nav-item" active-class="bg-gray-900 text-white"
        ...
        <div class="flex items-center space-x-4">
          <div class="flex items-center space-x-4">
            <div
              class="flex items-center justify-center bg-blue-500 text-white rounded-full w-12 h-12 text-lg font-semibold"
            >
              {{ customerInitials }}
            </div>
            <div>
