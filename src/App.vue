...
<template>
  <div>
    ...
    <main class="p-0">
      <!-- <Navbar v-if="isAuthenticated" :onLogout="handleLogout" /> -->
      <!-- <hr v-if="isAuthenticated" class="border-blue-500 mb-4" />
      <RouterLink v-if="!isAuthenticated" to="/login" class="text-blue500 hover:underline">Go to Login</RouterLink>
      <RouterLink v-if="!isAuthenticated" to="/about" class="text-blue500 hover:underline ml-4">About</RouterLink>
      <RouterLink v-if="isAuthenticated" to="/" class="text-blue500 hover:underline">Go to Home</RouterLink>
      <RouterLink v-if="isAuthenticated" to="/dashboard" class="text-blue500 hover:underline ml-4">Dashboard</RouterLink>
